...
# Set tools path
CLANG_PATH="${TOP}/tools/clang/host/linux-x86/clang-r383902b1/bin"
...
export LD_LIBRARY_PATH="$TOP/tools/clang/host/linux-x86/clang-r383902b1/lib64:$LD_LIBRARY_PATH"
